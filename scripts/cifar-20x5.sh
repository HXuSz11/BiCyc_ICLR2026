...
do
  for VAL in 1
  do
    CUDA_VISIBLE_DEVICES=1 python src/main_incremental.py \
    --approach bicyc \
    --datasets cifar100_icarl --num-tasks 20 --nc-first-task 5 \
    ...
    --exp-name 20x5_seed${SEED}/ --results-path ../results_bicyc_ICLR_camera_ready/
  done
done
