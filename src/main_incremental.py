...
def main(argv=None):
    ...
    parser.add_argument('--results-path', type=str, default='../results_bicyc_ICLR_gaussian',
    ...
    base_kwargs = dict(nepochs=args.nepochs, lr=args.lr, lr_min=args.lr_min, lr_factor=args.lr_factor,
                       ...
                       wu_lr_factor=args.warmup_lr_factor, fix_bn=args.fix_bn, eval_on_train=args.eval_on_train, num_tasks= args.num_tasks, nc_first_task=args.nc_first_task, datasets= args.datasets,)
    ...
    # appr = Appr(net, device, test_dataset=tst_loader, **appr_kwargs)
    ...
    for t, (_, ncla) in enumerate(taskcla):
        ...
        # Train
        appr.train(t, trn_loader[t], val_loader[t], all_val_loader=val_loader)
        print('-' * 108)
        # if t < 9:
        #     continue
